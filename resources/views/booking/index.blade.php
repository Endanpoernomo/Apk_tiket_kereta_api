...
<div class="card">
    <div class="card-header w-100 d-flex justify-content-between align-items-center">
        <div>
            <h3 class="card-title">Booking Kereta</h3>
        </div>
    </div>
    <!-- /.card-header -->
      ...
      <table class="dataTable table table-bordered table-striped ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="align-middle text-left">{{ $journey->keberangkatan->station_code . " | " . $journey->keberangkatan->station_name }}</td>
                <td class="align-middle text-left">{{ $journey->kedatangan->station_code . " | " . $journey->kedatangan->station_name }}</td>
                ...
                <td class="align-middle text-left d-flex justify-content-around align-items-center">
                    <a href="{{ asset("booking/detail/$journey->id") }}" class="btn btn-primary">
                        <div class="text-white">Lihat</div>
                    </a>
                </td>
            </tr>
            @endforeach
